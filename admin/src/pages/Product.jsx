  ...
  return (
    <div className="p-5 w-[70vw]">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <Link to="/newproduct">
          <button className="bg-slate-400 p-[10px] font-semibold text-white cursor-pointer">Create</button>
        </Link>
      </div>
      {/* Second Part */}
        ...
        <form action="" className="flex flex-col md:flex-row gap-5">
          ...
          <div className="flex-1 space-y-5">
            ...
            <div>
              ...
              <select name="" id="" className="w-full p-2 border border-gray-300 rounded">
