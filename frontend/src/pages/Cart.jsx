    ...
    <div className="min-h-screen p-8">
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 bg-white shadow-md rounded-lg p-6">
          <h3 className="text-x1 font-semibold mb-4">Your Items</h3>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              ...
              <div className="flex-1 ml-4">
                <h3 className="text-xl font-semibold mb-2">
                  Garnier Pure Active 3 in 1 Charcoal Anti Blackhead Mask Wash
                  Scrub
                </h3>
                <p className="text-gray-600 mb-2">
                  Garnier Pure Active 3 in 1 Anti Blackhead Charcoal can be used
                  as a Face Wash, Blackhead Scrub and C...
                </p>
                <div className="flex items-center my-5 p-4">
                  <FaMinus className="bg-[#ef93db] text-white cursor-pointer p-2 rounded-full mr-4 text-3xl" />
                  <span className="text-lg font-semibold mx-4">1</span>
