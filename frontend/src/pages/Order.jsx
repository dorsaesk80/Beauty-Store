    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
                  ...
                  <div className="flex items-center justify-evenly border-b border-gray-200 pb-4">
                    ...
                    <div className="flex-1 ml-4">
                      <h4 className="text-lg font-semibold">
                        Makis Grapeseed & Sweet Almond Oil-30Ml, For Dull
                      </h4>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-gray-600">dorsa.esk80@gmail.com</p>
          <p className="text-gray-600">+ (656) 789 254</p>
          <p className="text-gray-600">Dorsa Esk</p>
        </div>

        <div className="bg-gray-50 rounded-lg my-2">
          <h3 className="text-xl font-semibold mb-2">Peyment Method</h3>
